    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse " id="navmenu">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a href="bookappo.php" class="nav-link">Book appointment</a>
                </li>
                <li class="nav-item">
                    <a href="vi.php" class="nav-link">View Doctors</a>
                </li>
                <li class="nav-item">
                    <a href="ind.php" class="nav-link">Log out</a>
                </li>
            </ul>
        </div>
    </div>
...
<section id="doctors" class="p-5 bg-info">
    <div class="container">
        <h2 class="text-center text-white">Our Doctors</h2>
